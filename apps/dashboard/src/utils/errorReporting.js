 ...
 */
export function logErrorToStorage(error) {
    try {
 ...
 */
export async function reportErrorToService(error) {
 ...
 */
export function reportBoundaryError(error, errorInfo, componentName, severity = 'high') {
    const errorReport = {
        type: 'error_boundary',
 ...
 */
export function getErrorsByComponent(componentName) {
 ...
 */
export function exportErrorsAsJSON() {
    const errors = getStoredErrors();
 ...
 */
export function downloadErrorsReport() {
